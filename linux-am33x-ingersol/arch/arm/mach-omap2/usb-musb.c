...
void __init usb_musb_init(struct omap_musb_board_data *musb_host_board_data)
...
{	
	...
	if (musb_host_board_data)
		board_data = musb_host_board_data;
	else
...
#if 0 
        if(musb_host1_board_data != NULL) { 
           
           musb_plat[1].clock = "ick";
           musb_plat[1].board_data = musb_host1_board_data;
           musb_plat[1].power = musb_host1_board_data->power >> 1;
           musb_plat[1].mode = musb_host1_board_data->mode;
           musb_plat[1].extvbus = musb_host1_board_data->extvbus;
        }
#endif        
        /*
